...
function Header() {
  return (
    <div className="flex justify-between dark:bg-[#0a0a0a] bg-white py-1 items-center sm:p-4 min-w-full mb-2 md:mb-13 sticky top-0 right-0 left-0  px-2 sm:px-5 lg:px-20 border-b dark:border-[#1c1d21] border-gray-300 z-10">
